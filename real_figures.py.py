...
def fig2():
    ...
    plt.ylabel('Peak Δ'); plt.title('Cross-system')
    plt.ylim(0,1.2)
    ...
    plt.tight_layout()
    plt.savefig('fig2_real.png', dpi=300); plt.close()
    print('fig2_real.png OK')
...
def fig3():
    ...
    print("Delta values:", delta)   # 会打印在控制台，应该显示 [0.18,0.256,0.284,0.312,0.324,0.332,0.308,0.156]
    ...
    plt.tight_layout()
    plt.savefig('fig3_real.png', dpi=300); plt.close()
    print('fig3_real.png OK')

if __name__ == '__main__':
    fig1()
    fig2()
    fig3()
    print("All done! Check the three files: fig1_real.png, fig2_real.png, fig3_real.png")